<template>
  <div class="page">
    ...
    <div class="page-header">
      <h1 class="page-title">COGS NDT</h1>
...
export default {
  ...
  data() {
    return {
      ...
      items: [],
      fields: [
        { key: 'actions', label: 'Actions', class: 'table-action', stickyColumn: true },
        ...
        { key: 'stdManHrs', label: 'Standard Man Hours (Hour)', sortable: true },
